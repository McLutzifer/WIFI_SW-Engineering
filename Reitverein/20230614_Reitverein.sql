...
Startzeit	     Mitglied	Pferd	Reitplatz
2022-07-01 16:00	1		1		1
2022-07-01 17:00	1		1		2
2022-07-01 18:00	1		2		1
2022-07-01 19:00	2		1		1
2022-07-01 20:00	1		1		1
2022-07-01 20:00	2		2		2

*/
	

	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 1, '2022-07-01 16:00', 1)
	
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 1, '2022-07-01 17:00', 2)
	
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 2, '2022-07-01 18:00', 1)
	
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(2, 1, '2022-07-01 19:00', 1)
	
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 1, '2022-07-01 20:00', 1)
	
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(2, 2, '2022-07-01 20:00', 2)
...
---------------------------------------------------
	/* Excel sheet failing
Testfall 1
2022-08-02 09:00	1	1	1
2022-08-02 09:00	1	2	2
*/
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 1, '2022-08-02 09:00', 1)
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 2, '2022-08-02 09:00', 2)
-- ERROR ! 
	
	DELETE FROM Trainings WHERE Startzeit = '2022-08-02 09:00' and ReiterID = 1
...
Testfall 2
2022-08-02 09:00	1	1	1
2022-08-02 09:00	2	1	2
*/

	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 1, '2022-08-02 09:00', 1)
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(2, 1, '2022-08-02 09:00', 2)
	-- ERROR ! 
...
Testfall 2
2022-08-02 09:00	1	1	1
2022-08-02 09:00	2	1	2ROR !
*/
	
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(1, 1, '2022-08-02 09:00', 1)
	INSERT INTO Trainings (ReiterID, PferdeID, Startzeit, ReitplatzID) VALUES
	(2, 2, '2022-08-02 09:00', 1)
	-- ERROR !
